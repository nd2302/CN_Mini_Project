...
int main()
{
    ...
    if (sock_raw < 0)
    {
        // Prints the error with a proper message.
        perror("Socket Error");
        return 1;
    }
    while (1)
...
int getType(int val1, int val2, int val3)
{
    ...
    else if (strncmp(mac, "00065B", 3) == 0)
    { // Dell Laptop
        return 0;
    }
    else if (strncmp(mac, "00061B", 3) == 0)
    { // Lenovo Notebook
        return 0;
    }
    else if (strncmp(mac, "0012FE", 3) == 0)
    { // Lenovo Mobile
        return 1;
    }
    else if (strncmp(mac, "001321", 3) == 0)
    { // HP Laptops
        return 0;
    }
    else if (strncmp(mac, "001320", 3) == 0)
    { // Intel Corporate
        return 0;
    }
    else if (strncmp(mac, "009EC8", 3) == 0)
    { // Xiaomi Comm.
        return 1;
    }
    else if (strncmp(mac, "0000F0", 3) == 0)
    { // Samsung Mobile
        return 1;
    }
    else if (strncmp(mac, "FCFC48", 3) == 0)
    { // Apple Mobile
        return 1;
    }

    else if (strncmp(mac, "FCE557", 3) == 0)
    { // Nokia Mobile
        return 1;
    }
    else if (strncmp(mac, "000039", 3) == 0)
    { // Toshiba Laptop
        return 0;
    }
    else if (strncmp(mac, "000255", 3) == 0)
    { // IBM PC
        return 0;
    }
    else
